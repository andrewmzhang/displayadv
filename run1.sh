...
export VW_BIN=/ebs/vowpal_wabbit/vowpalwabbit
...
python ../scripts/vw_run1.py quad_11 1 6000000
python ../scripts/vw_run1.py quad_13 1 100000
python ../scripts/vw_run1.py quad_12 1 10000
date
